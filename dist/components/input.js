...
const Error = _styledComponents.default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  padding-top:4px;\n  color:red;\n  font-size:0.6rem;\n"])));

const Inline = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  display:flex;\n  justify-content:space-between\n  align-items:center;\n  padding-top:", ";\n  max-height:", ";\n  border-bottom:1px solid ", ";\n  &:focus-within{\n    max-height:unset;\n  }\n  &:focus-within > div{\n    opacity:1;\n  }\n"])), p => p.value || p.error ? "4px" : "", p => p.value ? "unset" : 0, p => p.error ? "red" : "transparent");

const Prefix = _styledComponents.default.div(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  font-size:1rem;\n  opacity:", ";\n"])), p => p.value ? "1" : "0");

const Postfix = (0, _styledComponents.default)(Prefix)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral([""])));
const StyledCopy = (0, _styledComponents.default)(_reactFeather.Copy)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  cursor:pointer;\n  height:18px;\n  width:18px;\n  margin-right:10px;\n"])));
const StyledX = (0, _styledComponents.default)(_reactFeather.X)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  cursor:pointer;\n  height:20px;\n  width:20px;\n"])));